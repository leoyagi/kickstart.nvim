-- Temporary workaround treesitter Inspect
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>fc', require('telescope.builtin').lsp_document_symbols, '[D]o[c]ument Symbols')

          -- Fuzzy find all the symbols in your current workspace.
          --  Similar to document symbols, except searches over your entire project.
          map('<leader>fk', require('telescope.builtin').lsp_dynamic_workspace_symbols, 'Wor[k]space Symbols')
          ...
          vim.keymap.set('n', '<leader>ed', vim.diagnostic.open_float, { desc = '[E]xpand Float [D]iagnostic' })
        end,
      })
